...
public class TeleinfoTcpipServer {

    private static final Logger LOGGER = LoggerFactory.getLogger(TeleinfoTcpipServer.class);

    private InetAddress serverAddress;
    private int serverPort;
    private IoAcceptor acceptor;

    public TeleinfoTcpipServer(final int serverPort) {
        this(null, serverPort);
    }

    public TeleinfoTcpipServer(final InetAddress serverAddress, final int serverPort) {
    ...
    public void start() throws Exception {
        ...
        acceptor.setHandler(new TeleinfoTcpipServerHandler());
